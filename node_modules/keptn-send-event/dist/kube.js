...
exports.sendKubeEvent = void 0;
const js_yaml_1 = require("js-yaml");
const js_base64_1 = require("js-base64");
const k8s = __importStar(require("@kubernetes/client-node"));
const net = __importStar(require("net"));
const fetch_1 = require("./fetch");
async function sendKubeEvent(kubeSettings, event) {
    ...
    // Send request
    const response = await (0, fetch_1.sendEvent)(`http://${hostname}:${port}/api/v1/event`, token, event);
...
exports.sendKubeEvent = sendKubeEvent;
