...
exports.kubeUpdateService = void 0;
const js_base64_1 = require("js-base64");
const k8s = __importStar(require("@kubernetes/client-node"));
const net = __importStar(require("net"));
const event_1 = require("../event");
async function kubeUpdateService(kubeConnect, event) {
    ...
    console.log(`KUBE: Got Keptn API token from secret (***${token.slice(-2)})`);
    ...
    console.log(`KUBE: Service name for port-forwarding: ${kubeConnect.service}`);
    ...
    await (0, event_1.sendEvent)({ keptnURL: `http://${hostname}:${port}`, token: token }, event);
...
exports.kubeUpdateService = kubeUpdateService;
